...
class formDataWidgetMulticity extends StatefulWidget {
  bool isShow;
  int index;
  bool isReturn;
  formDataWidgetMulticity({Key key, this.isShow, this.index,this.isReturn}) : super(key: key);
  @override
  _formDataWidgetMulticityState createState() => _formDataWidgetMulticityState();
}
...
class _formDataWidgetMulticityState extends State<formDataWidgetMulticity> {
  @override
  void initState() {
    super.initState();
    getLocationList();
