...
class ReturnBookingPagee extends StatefulWidget {
  final Flight flightmodel,flightmodel2;
  int travellerCount;
  String fromcity, tocity;
  ReturnBookingPagee(
      {this.flightmodel,this.flightmodel2, this.travellerCount, this.fromcity, this.tocity});

  @override
  State<ReturnBookingPagee> createState() => _ReturnBookingPageeState();
}

class _ReturnBookingPageeState extends State<ReturnBookingPagee> {
  @override
  void initState() {
    super.initState();
   log("priceid: ${widget.flightmodel.pricceID},2:${widget.flightmodel.pricceID}");
  ...
  getrevalidateDomesticOnewayAPI() async {
    ...
    pricelist.add(widget.flightmodel.pricceID);
    String res = await revalidateDomesticOnewayAPI(pricelist);
    ...
    // getfarerulrreviewAPI(bookingId);
  }
