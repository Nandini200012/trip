...
Future<String> getHolidayPackagesdetailsAPI(String p_id) async {
  print("holidayPackages byid  ");
  var url = Uri.parse(
      'https://gotodestination.in/api/get_holiday_packages_by_id.php?p_id=$p_id');
      printWhite("url:$url");
...
class HolidayPackagedetails {
    ...
    factory HolidayPackagedetails.fromJson(Map<String, dynamic> json) => HolidayPackagedetails(
        errorCode: json["error_code"],
        errorMessage: json["error_message"],
        packages: List<Details>.from(json["packages"].map((x) => Details.fromJson(x))),
    );
